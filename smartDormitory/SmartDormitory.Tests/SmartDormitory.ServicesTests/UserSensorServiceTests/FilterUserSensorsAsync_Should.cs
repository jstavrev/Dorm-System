    ...
    public class FilterUserSensorsAsync_Should
    {
        ...
        public async Task ThrowArgumentNullException_WhenPassedNullSortOrder()
        {
            ...
            using (var assertContext = new SmartDormitoryDbContext(contextOptions))
            {
                ...
                await Assert.ThrowsExceptionAsync<ArgumentNullException>(async () => await userSensorService.FilterUserSensorsAsync(userId, sortOrder, validFilter, validPageNumber, validPageSize));
            }
        }
